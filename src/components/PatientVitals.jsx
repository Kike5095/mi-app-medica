  ...
  if (showingNotes) {
    return (
      <main className="container">
        <nav>
          <ul><li><button className="secondary outline" onClick={() => setShowingNotes(false)}>&larr; Volver al Historial</button></li></ul>
          <ul><li><h2>Notas de Enfermería de: {patient.name}</h2></li></ul>
        </nav>
    ...
    <main className="container">
      ...
      <article>
        <form onSubmit={handleAddVital}>
          ...
          <label>Nota de Enfermería (adjunta a la toma)</label>
